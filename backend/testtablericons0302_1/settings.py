"""
Django settings for testtablericons0302_1 project.
...
ROOT_URLCONF = 'testtablericons0302_1.urls'
...
WSGI_APPLICATION = 'testtablericons0302_1.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "TestTablerIcons0302 Support <support@testtablericons0302-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testtablericons0302_1 API",
    "DESCRIPTION": "API documentation for testtablericons0302_1 App",
    "VERSION": "v1",
}
